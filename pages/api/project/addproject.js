...
async function addProject(req, res) {
    if (req.method == 'POST') {
        try {
            ...
            var addUserQuery = await executeQuery("INSERT INTO `tbl_project` ( `project_title`, `project_description`, `project_language` , `project_department`, `project_priority`, `project_start`, `project_deadline` , `project_person`, `project_status`, `project_delete` ) VALUES (?,?,?,?,?,?,?,?,?,?)",
